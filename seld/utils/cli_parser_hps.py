...
def parse_cli_overides():
    ...
    *preprocess*, *train*, *predict*, and *evaluate*. Specifying a
    ...
    parser_train.add_argument('--r', type=float, default=0.1, metavar='N')
    #parser_train.add_argument('--decay_parameter', default=1e-3)
    ...
    parser_infer.add_argument('--r', type=float, default=0.1, metavar='N')
